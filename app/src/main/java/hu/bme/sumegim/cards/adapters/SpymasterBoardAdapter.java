...
public class SpymasterBoardAdapter extends RecyclerView.Adapter<WhiteCardsAdapter.ViewHolder> {
    ...
    public SpymasterBoardAdapter(Context context) {
    ...
    @Override
    public WhiteCardsAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_spymaster_card, viewGroup, false);
        WhiteCardsAdapter.ViewHolder vh = new WhiteCardsAdapter.ViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(final WhiteCardsAdapter.ViewHolder viewHolder, final int position) {
